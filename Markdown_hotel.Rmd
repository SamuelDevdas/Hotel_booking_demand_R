...
The resulting plot can be used to explore the distribution of hotel bookings and lead times across different countries. The size of the circles represents the lead time, and hovering over a circle displays information about the country and lead time in a tooltip.
